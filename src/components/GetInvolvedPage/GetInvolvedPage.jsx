...
<div className="card mb-3">
    <div className="row g-0">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" className="bi bi-mailbox" viewBox="0 0 16 16">
  ...
  <path d="M11.793 8.5H9v-1h5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.354-.146l-.853-.854zM5 7c0 .552-.448 0-1 0s-1 .552-1 0a1 1 0 0 1 2 0z"/>
        ...
        <div className="card-body">
            ...
            <i className="fa-sharp fa-solid fa-mailbox"></i>
...
<div className="card mb-3" sx={{maxWidth: '540px'}}>
    <div className="row g-0">
        <div className="col-md-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" className="bi bi-pencil" viewBox="0 0 16 16">
...
<div className="card mb-3" sx={{maxWidth: '540px'}}>
    <div className="row g-0">
        <div className="col-md-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" className="bi bi-gift" viewBox="0 0 16 16">
...
<div className="card mb-3" sx={{maxWidth: '540px'}}>
    <div className="row g-0">
        <div className="col-md-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" className="bi bi-bus-front" viewBox="0 0 16 16">
